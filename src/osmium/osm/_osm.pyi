...
from .mutable import Node as MutableNode, Way as MutableWay, Relation as MutableRelation
from .basetypes import OSMObjectIdType, VersionType, UidType, UnsginedOSMObjectIdType, ChangesetId
...
class Relation(OSMObject):
    ...
    def replace(self) -> MutableRelation: ...
